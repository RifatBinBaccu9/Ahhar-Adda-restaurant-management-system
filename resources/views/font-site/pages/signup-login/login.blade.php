        ...
        <div class="col-12 col-md-6 col-xl-7 " >
          <div class="d-flex justify-content-center text-bg-primary">
            <div class="col-12 col-xl-9">
              ...
              <h2 class="h1 mb-4">Best Restaurant For Yourself and Your Family</h2>
              <p class="lead mb-5">Ahaar Adda is a cozy restaurant offering delicious Bangladeshi and international dishes. Perfect for family gatherings, it also provides online ordering and table reservation for added convenience.</p>
              <div class="text-endx">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    ...
                    <h3 class="fs-6 fw-normal text-secondary m-0">Enter your Email & password to login</h3>
                  </div>
                </div>
              </div>
